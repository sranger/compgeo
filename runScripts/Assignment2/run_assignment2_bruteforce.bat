...
java -Djava.net.useSystemProxies=true -XX:MaxPermSize=256m -Xmx4096m com.stephenwranger.compgeo.assignment2.Assignment2 BruteForceSegmentIntersection %1 %2