...
To Run: 
	cd runScripts/Assignment1
	run_assignment1_bruteforce.(bat/sh) <number_of_points_or_pointfile> [--ui]
	run_assignment1_jarvis.(bat/sh) <number_of_points_or_pointfile> [--ui]
